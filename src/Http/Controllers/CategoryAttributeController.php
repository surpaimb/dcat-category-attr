...
namespace Dcat\Admin\Extension\DcatCategoryAttr\Http\Controllers;

use Dcat\Admin\Extension\DcatCategoryAttr\Http\Repositories\CategoryAttribute;
use Dcat\Admin\Form;
use Dcat\Admin\Grid;
...
class CategoryAttributeController extends AdminController
{
    ...
    {
        return Grid::make(new CategoryAttribute(), function (Grid $grid) {
    ...
    {
        return Form::make(new CategoryAttribute(), function (Form $form) {
            $form->display('id');
